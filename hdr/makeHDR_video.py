...
Path_to_sourceDir = r'\\192.168.1.8\SkyCam_FTP\camera_2\cam_2_vers1\20180213_raw_cam2'
...
def main():
    try:
        ...
        print('makeHDR_video.py started.')

        if not os.path.exists(join(Path_to_sourceDir, 'temp')):
            print('Started to unzip files.')
