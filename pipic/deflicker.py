...
def main(argv):
    ...
    print('Running with:')
    print('\tinput      : {}'.format(args.infix))
    print('\tbrightness : {}'.format(args.bright))
    print('\tpixelavg   : {}'.format(args.pixelavg))
    print('\tthresh     : {}'.format(args.thresh))
    print('\tannotate   : {}'.format(args.annotate))
    print('\tcompare    : {}'.format(args.compare))
    print('\toutput     : {}'.format(args.outfix))
    ...
    for i in range(N):
        if i%100==0: print('{} -> {}'.format(i,image_list[i]))
